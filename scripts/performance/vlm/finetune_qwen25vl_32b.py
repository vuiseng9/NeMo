...
def override_recipe_configs(
    ...
    """
    Qwen25VL-32B finetune recipe aimed at achieving best possible performance.
...
if __name__ == "__main__":
    ...
    kwargs = get_user_configs(args.gpu.lower(), "finetune", "qwen25vl", "32b", args)
    ...
    exp_name = f"qwen25vl_32b_finetune_{args.compute_dtype}_{exp_config}"
